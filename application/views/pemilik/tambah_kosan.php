...
<body class="min-h-screen justify-center">
    <div class="container mx-auto px-4 py-6 max-w-2xl">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Tambah Kosan Baru</h1>
        ...
        <?php endif; ?>
        <form method="post" action="<?php echo base_url('pemilik/tambah_kosan'); ?>" enctype="multipart/form-data" id="form-tambah-kosan" class="bg-white p-6 rounded-lg shadow-md">
            <div class="mb-4">
                <label for="nama" class="block text-gray-700 font-medium mb-2">Nama Kosan</label>
                <input type="text" class="form-control w-full p-2 border rounded-lg" id="nama" name="nama" value="<?php echo set_value('nama'); ?>" required>
            </div>
            <div class="mb-4">
                <label for="alamat" class="block text-gray-700 font-medium mb-2">Alamat</label>
                <textarea class="form-control w-full p-2 border rounded-lg" id="alamat" name="alamat" required rows="4"><?php echo set_value('alamat'); ?></textarea>
            </div>
            <div class="mb-4">
                <label for="kecamatan" class="block text-gray-700 font-medium mb-2">Kecamatan</label>
                <input type="text" class="form-control w-full p-2 border rounded-lg" id="kecamatan" name="kecamatan" value="<?php echo set_value('kecamatan'); ?>" required>
            </div>
            <div class="mb-4">
                <label for="desa" class="block text-gray-700 font-medium mb-2">Desa</label>
                <input type="text" class="form-control w-full p-2 border rounded-lg" id="desa" name="desa" value="<?php echo set_value('desa'); ?>" required>
            </div>
            <div class="mb-4">
                <label for="harga" class="block text-gray-700 font-medium mb-2">Harga per Bulan (Rp)</label>
                <input type="number" class="form-control w-full p-2 border rounded-lg" id="harga" name="harga" value="<?php echo set_value('harga'); ?>" required min="0">
            </div>
            <div class="mb-4">
                ...
                <select class="form-control w-full p-2 border rounded-lg" id="tipe" name="tipe" required>
                    <option value="putra" <?php echo set_select('tipe', 'putra'); ?>>Putra</option>
                    <option value="putri" <?php echo set_select('tipe', 'putri'); ?>>Putri</option>
                    <option value="campur" <?php echo set_select('tipe', 'campur'); ?>>Campur</option>
                </select>
            </div>
            <div class="mb-4">
                ...
                <select class="form-control w-full p-2 border rounded-lg" id="kepribadian" name="kepribadian" required>
                    <option value="introvert" <?php echo set_select('kepribadian', 'introvert'); ?>>Introvert</option>
                    <option value="extrovert" <?php echo set_select('kepribadian', 'extrovert'); ?>>Extrovert</option>
                    <option value="ambivert" <?php echo set_select('kepribadian', 'ambivert'); ?>>Ambivert</option>
                </select>
            </div>
            <div class="mb-4">
                <label for="jumlah_kamar" class="block text-gray-700 font-medium mb-2">Jumlah Kamar</label>
                <input type="number" class="form-control w-full p-2 border rounded-lg" id="jumlah_kamar" name="jumlah_kamar" value="<?php echo set_value('jumlah_kamar'); ?>" required min="1">
            </div>
            <div class="mb-4">
                <label for="kamar_tersedia" class="block text-gray-700 font-medium mb-2">Kamar Tersedia</label>
                <input type="number" class="form-control w-full p-2 border rounded-lg" id="kamar_tersedia" name="kamar_tersedia" value="<?php echo set_value('kamar_tersedia'); ?>" required min="0">
            </div>
            <div class="mb-4">
                <label for="deskripsi" class="block text-gray-700 font-medium mb-2">Deskripsi</label>
                <textarea class="form-control w-full p-2 border rounded-lg" id="deskripsi" name="deskripsi" rows="4"><?php echo set_value('deskripsi'); ?></textarea>
            </div>
            <div class="mb-4">
                <label for="google_maps_link" class="block text-gray-700 font-medium mb-2">Link Google Maps (Opsional)</label>
                <input type="url" class="form-control w-full p-2 border rounded-lg" id="google_maps_link" name="google_maps_link" value="<?php echo set_value('google_maps_link'); ?>">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="foto_kosan" class="block text-gray-700 font-medium mb-2">Foto Kosan (Maksimal 8, masing-masing < 2MB)</label>
                ...
                <p class="text-sm text-gray-500 mt-1">Pilih hingga 8 file gambar (jpg, jpeg, png) dengan ukuran masing-masing < 2MB.</p>
            </div>
            <div class="text-center">
                <button type="submit" class="btn-primary text-white font-medium py-2 px-6 rounded-lg">Tambah Kosan</button>
            </div>
        </form>
    </div>
