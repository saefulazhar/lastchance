<div class="container mt-4">
    ...
    <?php endif; ?>
    <form method="post" action="<?php echo base_url('pemilik/tambah_kosan'); ?>" enctype="multipart/form-data" id="form-tambah-kosan">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="alamat" name="alamat" required><?php echo set_value('alamat'); ?></textarea>
        </div>
        <div class="mb-3">
            <label for="kecamatan" class="form-label">Kecamatan</label>
            <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="<?php echo set_value('kecamatan'); ?>" required>
        </div>
        <div class="mb-3">
            <label for="desa" class="form-label">Desa</label>
            <input type="text" class="form-control" id="desa" name="desa" value="<?php echo set_value('desa'); ?>" required>
        </div>
        <div class="mb-3">
            <label for="harga" class="form-label">Harga per Bulan (Rp)</label>
            <input type="number" class="form-control" id="harga" name="harga" value="<?php echo set_value('harga'); ?>" required min="0">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="jumlah_kamar" name="jumlah_kamar" value="<?php echo set_value('jumlah_kamar'); ?>" required min="1">
        </div>
        <div class="mb-3">
            <label for="kamar_tersedia" class="form-label">Kamar Tersedia</label>
            <input type="number" class="form-control" id="kamar_tersedia" name="kamar_tersedia" value="<?php echo set_value('kamar_tersedia'); ?>" required min="0">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control" id="google_maps_link" name="google_maps_link" value="<?php echo set_value('google_maps_link'); ?>">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <small class="form-text text-muted">Pilih hingga 8 file gambar (jpg, jpeg, png) dengan ukuran masing-masing < 2MB.</small>
        </div>
